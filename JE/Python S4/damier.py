...
def genereDamier(nbLignes,nbColonnes):
    ...
    """ fonction qui génère un damier à la console c'est-à-dire une liste composée de plusieurs listes représentant chacune une colonne du damier avec à l'intérieur différents éléments qui correspondent aux lignes du damier
    Paramètres :
